...
const Home = () => {
  return (
    <>
     ...
     <p style={{textAlign:'center', margin: '10px'}}><span style={{fontSize: '140px', fontFamily:'Raleway, sans-serif', fontWeight:'bold', textAlign:'center'}}>A VISUAL EXPERIENCE</span></p>
     <p style={{textAlign:'center', margin: '10px'}}><span style={{fontSize: '140px', fontFamily:'Raleway, sans-serif', fontWeight:'bold', textAlign:'center', color: '#f8f8f8'}}>A ISUAL EXPERIENCEe</span></p>
     <p style={{textAlign:'center', margin: '10px'}}><span style={{fontSize: '140px', fontFamily:'Raleway, sans-serif', fontWeight:'bold', textAlign:'center'}}>A VISUAL EXPERIENCE</span></p>
     <p style={{textAlign:'center'}}><span style={{fontSize: '150px', fontFamily:'Raleway, sans-serif', fontWeight:'bold', textAlign:'center', color: '#f8f8f8'}}>A VISUAL EXPERIENCE</span></p>
  ...
  {/* <Gallery /> */}
      ...
      <UXWorks />
      <Parallax bgImage={Group} blur={5} strength={200}>
